...
module AlignmentPracticableIORepa (
  ...
  parametersSystemsHistoryRepasDecomperMaximumRollExcludedSelfHighestFmaxLabelMinEntropyIORepa_1,
...
parametersSystemsLayererMaximumRollExcludedSelfHighestIORepa_u =
  parametersSystemsLayererMaxRollTypeExcludedSelfHighestIORepa_u MaximumRoll
 
parametersSystemsLayererMaxRollTypeExcludedSelfHighestIORepa_u :: 
...
parametersSystemsLayererMaxRollTypeExcludedSelfHighestIORepa_u 
  ...
  where
    ...
    parter uu kk bb y1 = (if mroll == MaxRollByM then parametersSystemsPartitionerMaxRollByMRepa_ui else parametersSystemsPartitionerRepa_ui) 
...
parametersSystemsHistoryRepasDecomperMaximumRollExcludedSelfHighestFmaxIORepa
  wmax lmax xmax omax bmax mmax umax pmax fmax mult seed uu vv aa =
    parametersSystemsHistoryRepasDecomperMaxRollTypeExcludedSelfHighestFmaxLabelTypeIORepa 
  ...
  where
    ...
    layerer uu xx f = 
      do
        ...
        hFlush stdout
        parametersSystemsLayererMaxRollTypeExcludedSelfHighestIORepa_u mrollt
                                        wmax lmax xmax omax bmax mmax umax pmax uu vv xx xxp xxrr xxrrp f
...
parametersSystemsHistoryRepasDecomperLevelMaxRollByMExcludedSelfHighestFmaxIORepa 
  ...
  | wmax < 0 || lmax < 0 || xmax <= 0 || omax <= 0 || bmax < 0 || mmax < 1 || bmax < mmax || umax < 0 || pmax < 0 = 
      return $ Nothing
  | size aa == 0 || mult < 1 = return $ Nothing
  | not (vars aa `subset` uvars uu) = return $ Nothing
...
parametersSystemsLayererLevelMaximumRollExcludedSelfHighestIORepa_u :: 
  ...
  IO (System, Fud, [(Set.Set Variable, Double)])
parametersSystemsLayererLevelMaximumRollExcludedSelfHighestIORepa_u =
  parametersSystemsLayererLevelMaxRollTypeExcludedSelfHighestIORepa_u MaximumRoll

parametersSystemsLayererLevelMaxRollTypeExcludedSelfHighestIORepa_u :: 
  MaxRollType -> Integer -> Integer -> Integer -> Integer -> Integer -> Integer -> Integer -> Integer -> 
  System -> Set.Set Variable -> Fud -> 
  HistoryRepa -> HistogramRepaRed -> HistoryRepa -> HistogramRepaRed -> Integer -> Integer ->
  IO (System, Fud, [(Set.Set Variable, Double)])
...
parametersSystemsLayererLevelMaxRollByMExcludedSelfHighestIORepa_u :: 
  ...
  IO (System, Fud, [(Set.Set Variable, Double)])
parametersSystemsLayererLevelMaxRollByMExcludedSelfHighestIORepa_u =
  parametersSystemsLayererLevelMaxRollTypeExcludedSelfHighestIORepa_u MaxRollByM
